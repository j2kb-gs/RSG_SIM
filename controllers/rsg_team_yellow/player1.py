...
class MyPlayer1(RSGPlayerRobot):
    def run(self):
        ...
        if strategy == 1:
            print("Team Yellow is playing a Defensive Strategy")
        elif strategy == 2:
            print("Team Yellow is playing an Offensive Strategy")
        else:
            print("Team Yellow is playing a Collaborative Strategy")
