...
GOAL_YELLOW_Y_LIMIT = -0.745 * 4
GOAL_BLUE_Y_LIMIT = 0.745 * 4
GOAL_X_UPPER_LIMIT = 0.2 * 4
GOAL_X_LOWER_LIMIT = -0.209 * 4
GOAL_YELLOW_BACK_WALL_Y_LIMIT = -0.849 * 4
GOAL_BLUE_BACK_WALL_Y_LIMIT = 0.849 * 4

FIELD_Y_UPPER_LIMIT = 0.755 * 4
FIELD_Y_LOWER_LIMIT = -0.755 * 4
FIELD_X_UPPER_LIMIT = 0.655 * 4
FIELD_X_LOWER_LIMIT = -0.655 * 4
...
ROBOT_INITIAL_TRANSLATION = {
    "B1": [-1.3, 1.3, OBJECT_DEPTH],
    "B2": [0, 2.3, OBJECT_DEPTH],
    "B3": [0, 0.9, OBJECT_DEPTH],
    "B4": [1.3, 1.3, OBJECT_DEPTH],
    "Y1": [-1.3, -1.3, OBJECT_DEPTH],
    "Y2": [0, -2.3, OBJECT_DEPTH],
    "Y3": [0, -0.9, OBJECT_DEPTH],
    "Y4": [1.3, -1.3, OBJECT_DEPTH],
}
